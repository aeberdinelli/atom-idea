...
export default {
    ...
    // line where the 'go-to' was called
    back: {
        file: '',
        line: -1,
        col: -1
    ...
    go() {
        ...
        if (this.back.line > -1 && this.back.file != '')
        {
            atom.workspace.open(this.back.file, {
                'initialLine': this.back.line,
                'initialColumn': this.back.col
            });
        ...
        // else, save the position for later use
        this.back = get_position();
